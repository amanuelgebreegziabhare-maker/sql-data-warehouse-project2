...
BEGIN 
    ...
    PRINT 'Inserting data into Silver Layer silver.crm_cust_info Table'
    ...
    PRINT 'Inserting data into Silver Layer silver.crm_sales_details Table'
    ...
    PRINT 'Inserting data into Silver Layer silver.erp_cust_az12 Table'
    ...
    PRINT 'Inserting data into Silver Layer silver.erp_loc_a101 Table'
    ...
    PRINT 'Inserting data into Silver Layer silver.erp_px_cat_g1v2 Table'
