...
--Track ETL Duration: Helps to identify bottlenecks, obtimize performance, moniter trends, detect issues
...
BEGIN 
	...
	BEGIN TRY
		...
		PRINT '================================================';
		PRINT 'Loading the three CRM Tables ';
		PRINT '================================================';
		...
		SET @start_time = GETDATE();
		PRINT 'Truncating the table: bronze.crm_prd_info table';
		PRINT '****************************************************';
		...
		PRINT '================================================';
		PRINT 'Loading the three ERP Tables ';
		PRINT '================================================';
